					...
					<div class="widget-content nopadding">
						<div class="bootstrap-iso">
							<div class="container-fluid">
								<div class="row">
										<form class="form-horizontal" method="post" action="{{ url('/admin/modifier-echantillon/' .$echantillonsDetails->id) }}" name="add_echan" id="add_echan" novalidate="novalidate"> {{ csrf_field() }}
											...
											<div class="form-group ">
												...
												<div class="col-sm-4">
													<textarea class="form-control" cols="40" id="formeGalenique" name="formeGalenique" rows="4">{{ $echantillonsDetails->formeGalenique }}</textarea>
												</div>
											</div>
											<div class="form-group ">
