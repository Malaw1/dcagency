...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-signal"></i> <span><strong>Echantillons</strong> </span></a> 
        <ul>
          <li><a href="#"><strong>Ajouter Echantillons</strong> </a></li>
          <li><a href="{{('../admin/echantillons/index_echan')}}">Listes Ecahntillons</a></li>
