...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul class="nav nav-sidebar">
    <li class="##"><a href="<?php echo e(('../admin/dashboard')); ?>"><i class="icon icon-home" style="font-size: 24px;color:  #fff"></i> <span> <strong>Accueil</strong> </span></a> </li>
    <li class="##"><a href="<?php echo e(('../reception/')); ?>"><i class="icon icon-save" style="font-size: 24px;color:  #fff"></i> <span> <strong>Reception</strong> </span></a> </li>
    <li class="submenu"> <a href="#"><i class="icon icon-beaker" style="font-size: 24px;color:  #fff"></i> <span><strong>Echantillons</strong> </span> <span class="label label-important">2</span> </a> 
     <ul>
        <li><a href="<?php echo e(url('/admin/add-echantillon')); ?>">Ajouter échantillons</a></li>
        <li><a href="<?php echo e(url('/admin/voir-echantillon')); ?>">Consulter échantillons</a></li>
    ...
    <li><a href="<?php echo e(('/stocks')); ?>"><i class="icon icon-fullscreen" style="font-size: 24px;color:  #fff"></i> <span><strong>Stock &amp; Fournisseur</strong> </span></a></li>
