					...
					<div class="widget-content nopadding">
						<div class="bootstrap-iso">
							<div class="container-fluid">
								<div class="row">
										<form class="form-horizontal" method="post" action="<?php echo e(url('/admin/add-echantillon')); ?>" name="add_echan" id="add_echan" novalidate="novalidate"> <?php echo e(csrf_field()); ?>
