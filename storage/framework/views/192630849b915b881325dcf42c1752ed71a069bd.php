...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="<?php echo e(('../admin/dashboard')); ?>"><i class="icon icon-home"></i> <span> <strong>Accueil</strong> </span></a> </li>
    ...
    <li><a href="buttons.html"><i class="icon icon-tint"></i><strong>Stock &amp; Fournisseurs</strong> </a></li>
