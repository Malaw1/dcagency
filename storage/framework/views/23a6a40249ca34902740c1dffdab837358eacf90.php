...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo e(asset('css/fonts.googleapis.com.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-part2.min.css" class="ace-main-stylesheet')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-skins.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-rtl.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/jquery-ui.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ui.jqgrid.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/fonts.googleapis.com.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace.min.css')); ?>" class="ace-main-stylesheet" id="main-ace-style" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-part2.min.css')); ?>" class="ace-main-stylesheet" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-skins.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-rtl.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-ie.min.css')); ?>" />
		...
		<link rel="stylesheet" href="<?php echo e(asset('css/bootstrap-colorpicker.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-skins.min.css')); ?>" />
		<link rel="stylesheet" href="<?php echo e(asset('css/ace-rtl.min.css')); ?>" />
		...
		<script src="<?php echo e(asset('js/ace-extra.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/wizard.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.validate.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery-additional-methods.min.js')); ?>"></script>
					...
					<ul class="nav ace-nav">
									...
									<ul class="dropdown-menu dropdown-navbar navbar-pink">
										...
										<li>
											<a href="#">
												...
												Nouvel Echantillon enregistrer
											</a>
										</li>
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo e(asset('images/avatars/avatar.png')); ?>" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">Modou:</span>
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo e(asset('images/avatars/avatar3.png')); ?>" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">Fatou:</span>
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo e(asset('images/avatars/avatar4.png')); ?>" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">Demba:</span>
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo e(asset('images/avatars/avatar2.png')); ?>" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">Nafi:</span>
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo e(asset ('images/avatars/avatar5.png')); ?>" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">Cheikh:</span>
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php echo e(asset('images/avatars/user.jpg')); ?>" alt="Jason's Photo" />
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> Echantillons </span>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo e(url('/admin/add-echantillon')); ?>">
							...
							<li class="">
								<a href="<?php echo e(url('/admin/voir-echantillon')); ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Liste Echantillons
								</a>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='<?php echo e(asset('js/jquery.mobile.custom.min.js')); ?>>"+"<"+"/script>");
		</script>
		...
		<script src="<?php echo e(asset('js/jquery.sparkline.index.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.flot.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.flot.pie.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.flot.resize.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/bootstrap.min.js')); ?>"></script>

		<!-- page specific plugin scripts -->
		<script src="<?php echo e(asset('js/bootstrap-datepicker.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.jqGrid.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/grid.locale-en.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('js/spinbox.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/bootstrap-datepicker.min.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('js/jquery.inputlimiter.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.maskedinput.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/bootstrap-tag.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/wizard.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery.validate.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/jquery-additional-methods.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/bootbox.js')); ?>"></script>
