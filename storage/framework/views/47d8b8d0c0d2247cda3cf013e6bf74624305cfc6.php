<!--Header-part-->
<div id="header">
  <h1><a href="<?php echo e(url('/admin/dashboard')); ?> ">Lims Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="<?php echo e(url('/admin/settings')); ?> "><i class="icon icon-cog"></i> <span class="text"><strong>Paramétre</strong></span></a></li>
    <li class=""><a title="" href=" <?php echo e(url('/logout')); ?> "><i class="icon icon-share-alt"></i> <span class="text"><strong>Déconexion</strong></span></a></li>
  </ul>
</div>
