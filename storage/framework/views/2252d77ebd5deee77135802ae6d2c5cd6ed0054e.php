...
<head>
    <title>LIMS_LNCM</title><meta charset="UTF-8" />
...
<body>
    <div id="loginbox">
        ...
        <form class="form-vertical" role="form" method="POST" action=" <?php echo e(url('admin')); ?> "> <?php echo e(csrf_field()); ?>
           ...
           <div class="control-group normal_text"> <h3><img src="<?php echo e(asset('images/backend_images/logo.ico')); ?>" alt="Logo" /></h3></div>
        ...
        <div class="form-actions">
            ...
            <span class="pull-right"><input type="submit" value="Connecter" class="btn btn-success" /> </span>
        </div>
    </form>
