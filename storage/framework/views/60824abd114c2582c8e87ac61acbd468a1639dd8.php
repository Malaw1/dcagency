		...
		<script type="text/javascript">
			...
			[
				<?php $__currentLoopData = $equip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					{id:["<?php echo e($equip->id); ?>"], appareil:["<?php echo e($equip->appareil); ?>"], code:["<?php echo e($equip->code); ?>"], 
					type:["<?php echo e($equip->type); ?>"], serie:["<?php echo e($equip->serie); ?>"], fabricant:["<?php echo e($equip->fabricant); ?>"],
					dateProchaineQualif:["<?php echo e($equip->dateQualification); ?>"], etat:["<?php echo e($equip->etat); ?>"],
					emplacement:["<?php echo e($equip->salle); ?>"], emplacement:["<?php echo e($equip->salle); ?>"], commentaire:["<?php echo e($equip->commentaires); ?>"],
					},
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'emplacement',index:'emplacement', width:10, sortable:false,editable: true}, 
                        {name:'commentaire',index:'commentaire', width:20,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}}
					], 
				...
				function style_edit_form(form) {
					//enable datepicker on "etat" field and switches for "stock" field
					form.find('input[name=etat]').datepicker({format:'yyyy-mm-dd' , autoclose:true})
